...
export const CAMPUS_TABS: readonly TabDef[] = [
  ...
  { id: 'campus', label: 'Workshops & learning', hint: 'Departments, seminars, workshops, research centres' },
  { id: 'companies', label: 'Careers', hint: 'Employers, info sessions, career fairs' },
  { id: 'sports', label: 'Sports', hint: 'Aggie athletics and rec sports' },
  { id: 'clubs', label: 'Clubs & socials', hint: 'Student organizations and social events' },
  { id: 'research-events', label: 'Talks & research', hint: 'Seminars, symposia, labs, and research organizations' },
  ...
  { id: 'bcs', label: 'Community', hint: 'Bryan/College Station, beyond campus' },
