...
import { checkEligibility, parseEligibility } from '@/studies/parse-eligibility.ts';
import { NO_MAX_AGE_SENTINEL } from '@/studies/types.ts';
import type { ParsedEligibility, RawStudy, UserProfile } from '@/studies/types.ts';
